...
import com.tntra.pargo2.stats.LocalStatsData;
import com.tntra.pargo2.stats.RemoteStatsData;
import com.tntra.pargo2.stats.StatsData;
import com.tntra.pargo2.ui.VideoGridContainer;
...
public class LiveActivity extends RtcBaseActivity {
    ...
    private void initUI() {
        ...
        int role = getIntent().getIntExtra(
                com.tntra.pargo2.Constants.KEY_CLIENT_ROLE,
        ...
        beautyBtn.setVisibility(View.INVISIBLE);
        beautyBtn.setActivated(true);
        rtcEngine().setBeautyEffectOptions(beautyBtn.isActivated(),
                com.tntra.pargo2.Constants.DEFAULT_BEAUTY_OPTIONS);

        mVideoGridContainer = findViewById(R.id.live_video_grid_layout);
        mVideoGridContainer.setStatsManager(statsManager());

        Log.e("TAG", "initUI: " + role);
    ...
    private void initData() {
        mVideoDimension = com.tntra.pargo2.Constants.VIDEO_DIMENSIONS[
    ...
    public void onJoinChannelSuccess(String channel, int uid, int elapsed) {
        ...
        Log.e("TAG", "onJoinChannelSuccess: " + channel);
    }
